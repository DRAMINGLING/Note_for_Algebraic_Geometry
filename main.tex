...
\begin{lemma}
    $Bl_{0}\mathbb{P}_{k}^{n} \subseteq \mathbb{P}_{k}^{n} \times \mathbb{P}_{k}^{n - 1}$ is defined by the bihomogenous polynomials $\{x_{i + 1}y_{j} - x_{j + 1}y_{i} \big{|} 0 \le i,j \le n - 1\}$.
    \label{Lemma 3.2}
\end{lemma}
\begin{proof}
