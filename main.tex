...
\begin{proof}
    ...
    Thus $F = \sum \frac{\partial F}{\partial y_{j/0}}(x)y_{j/0}$ is always contained in the linear subspace generated by $S$, denoted by $\langle S \rangle$.
...
\begin{theorem}[\textbf{\emph{Bertini's Theorem}}]
    ...
    Then for a general hyperplane $H$ of $\mathbb{P}_{k}^{n}$, $\varphi^{-1}(H)$ is still irreducible.
    \label{Theorem 5.7}
\end{theorem}
