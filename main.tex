...
\begin{proposition}[\textbf{\emph{Zariski Topology}}]
    ...
    (1)$\{V(I) \big{|} I \subseteq A \text{ ideal}\}$ form the closed subsets of a topology on $\spec A$ called the Zariski topology. \\
    (2)$\{D(f) \big{|} f\in A\}$ form a basis of the topology, called standard open subsets.
