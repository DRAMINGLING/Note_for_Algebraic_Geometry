...
\begin{proof}
    ...
    Assume that $S_{X}$ is a variety first.
    Denote coordinate of $\mathbb{P}_{k}^{n}$ by $y_{1}, \cdots, y_{n}$ and coordinate of ${\mathbb{P}_{k}^{n}}^{\vee}$ by $z_{1}, \cdots, z_{n}$.
    \par
    ...
    Thus $\sum \frac{\partial F}{\partial y_{j/0}}(x)y_{j/0}$ is always contained in the linear subspace generated by $S$, denoted by $\langle S \rangle$.
    ...
    And $p_{1}^{-1}(x) \cong \langle S \rangle \cap V(z_{0})$.
    It is clear that $\langle S \rangle$ is not contained in $V(z_{0})$.
