...
\begin{remark}
    ...
    For example, for projective curve $X \not\cong \mathbb{P}_{k}^{1}$,
    we can verify that line bundles in $\picardscheme (\Delta_{X})$ do not come from $\picardscheme (X) \times \picardscheme (X)$.
\end{remark}
